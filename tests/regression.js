...
const scenarios = [
    ...
    {
        name: 'latest level-five probe should keep the rear elephant flexible',
        timeBudgetMs: 5000,
        sequence: [
            '9,7-7,6','0,7-2,6','7,7-7,8','0,1-2,2','6,2-5,2','0,8-0,7','9,8-9,7','0,6-2,8','9,7-5,7','0,7-1,7','9,2-7,4','3,6-4,6','9,1-7,0','2,1-2,0','7,8-7,7','2,0-6,0','7,0-9,1','6,0-6,6','9,1-7,2','2,7-4,7','9,0-9,1','1,7-0,7','5,7-5,4','4,7-4,8','7,7-7,8','4,8-4,7','7,2-5,3','3,4-4,4','5,4-5,5','0,7-3,7','7,1-7,2','0,5-1,4','9,1-3,1','3,7-3,6','5,5-5,7','4,7-3,7','5,2-4,2','4,6-5,6','7,4-5,6','6,6-9,6','9,5-8,4','2,2-1,0','3,1-2,1','3,2-4,2','7,6-5,5','3,6-3,3','7,8-7,6','3,3-5,3','5,7-3,7','2,6-4,5','3,7-8,7','9,6-5,6','7,6-7,4','5,3-5,5','7,4-4,4','0,2-2,4','8,7-2,7','5,5-5,2','7,2-7,6','5,2-7,2','7,6-7,5'
        ],
        check(result) {
            assert(result.move, 'expected a move');
            assert.strictEqual(game.getMoveKey(result.move), '2,8-0,6', `expected 象9退7, got ${game.getMoveKey(result.move)}`);
        }
    }
];
